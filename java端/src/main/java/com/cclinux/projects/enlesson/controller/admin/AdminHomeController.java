...
import com.cclinux.projects.enlesson.service.admin.AdminHomeService;
import com.cclinux.projects.enlesson.service.cust.PublicService;
...
@RestController("EnLessonAdminHomeController")
public class AdminHomeController extends BaseMyAdminController {

    @Resource(name = "EnLessonAdminHomeService")
    private AdminHomeService adminHomeService;

    @Resource(name = "EnLessonPublicService")
