package com.cclinux.projects.enlesson.controller.cust;
...
import com.cclinux.projects.enlesson.service.cust.PassportService;
...
@RestController("EnLessonPassportController")
public class PassportController extends BaseMyCustController {

    @Resource(name = "EnLessonPassportService")
